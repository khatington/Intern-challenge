...
//declaring csvData to read CSV and retrieve employee data
const csvData = () => 
{
...
//confirmation that server has started and is listening for requests on port 5000
app.listen(PORT, () => {
    console.log(`******************************************`);
